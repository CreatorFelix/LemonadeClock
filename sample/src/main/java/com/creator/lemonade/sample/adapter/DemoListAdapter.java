...
import com.creator.lemonade.sample.activity.StopwatchActivity;
import com.creator.lemonade.sample.activity.TimerActivity;
...
public class DemoListAdapter extends RecyclerView.Adapter<DemoListAdapter.ViewHolder> {
    ...
    public DemoListAdapter(@NonNull Context context) {
        ...
        final Class[] classes = {ClockActivity.class, StopwatchActivity.class, TimerActivity.class};
